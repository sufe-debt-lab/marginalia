...
| CAP-SKILLS-001    | Skills                        | partial     | 六级 discovery、immutable Catalog、受保护管理 API、revision-pinned runtime、Composer picker，以及 Settings 启停/预览已实现 | blocked selection 修复未接入；API 不创建、安装、编辑或删除 Skill                          | P1-EXTENSIONS-001                       | `apps/pi-server/src/skills/catalog.ts`、`apps/desktop/src/settings/SkillsPane.tsx`、`apps/desktop/src/chat/Composer/Composer.tsx` | post-M0                    |
