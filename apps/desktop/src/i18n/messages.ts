export const en = {
  ...
  approval: {
    ...
    hostCommand:
      "Runs on your computer and may access files outside this workspace or the network. Approval applies only to this command.",
    modeEdit: "Edit existing file",
    modeWrite: "Replace file contents",
    approved: "Approved",
    denied: "Denied",
...
export const zh = {
  ...
  approval: {
    ...
    hostCommand: "命令在本机执行，可能访问工作区外文件或网络。批准仅适用于本次命令。",
    modeEdit: "编辑现有文件",
    modeWrite: "替换文件内容",
    approved: "已批准",
    denied: "已拒绝",
